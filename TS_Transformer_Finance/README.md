...
#### Dataset
Licence requirements prevent the dataset used in the experiments to be uploaded. The provided dataset consists of synthesised prices based on real prices that underwent a series of randomized transformations. It is of purely exemplary nature and obtained results will therefore vary from the examples provided. To obtain the real dataset, a consituent list including EIKON identifier codes for replicating it directly is provided in the accompanying paper.  
