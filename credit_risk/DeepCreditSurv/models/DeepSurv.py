...
class DeepSurv:
    def __init__(self, dataset='M1', file_path=None):
        if dataset == 'M1':
            ...
            self.x_train, self.x_val, self.x_test, self.y_train, self.y_val, self.durations_test, self.events_test = self._make_data(
    ...
    def _make_data(self, col_to_std, cat_feats, get_dummies=False):
        ...
        return x_train, x_val, x_test, y_train, y_val, durations_test, events_test
    ...
    def find_lr(self):
        ...
        batch_size = 256
        lr_finder = model.lr_finder(self.x_train, self.y_train, batch_size, tolerance=10)
        _ = lr_finder.plot()
    ...
    def build_model(self, lr=0.01):
        ...
        verbose = True
        log = model.fit(self.x_train, self.y_train, batch_size, epochs, callbacks, verbose,
